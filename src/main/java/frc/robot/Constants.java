...
public final class Constants {
  ...
  public static final class KElevator {
    ...
    public static final double BARGE_LEVEL =
        43; // currently impossible to achieve; max 44.048 without damaging; 41.7 without
    // overshoot
  }
  ...
  public static final class KArm {
    ...
    public static final double GROUND_INTAKE_ANGLE =
        5.6; // we do not know this yet; input correct angle later
    ...
    public static final double ROLLER_INTAKE_POWER = 0.4;
  }
}
